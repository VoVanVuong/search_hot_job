...
@Entity
@Table(name = "suitable_jobs")
public class SuitableJobs {
    @Id
    ...
    public SuitableJobs(int id, Cadidates cadidates, Categories categories, String createdAt, String updatedAt) {
        this.id = id;
